defmodule Nostrlib.Encoding.Nevent do
  @moduledoc """
  ...
  alias Nostrlib.Encoding.Nevent
  alias Nostrlib.Encoding.Nevent.{Instance, Tokens}
  ...
  ## Examples
      ...
      ...> |> Nostrlib.Encoding.Nevent.decode
      {
        :ok,
        %Nostrlib.Encoding.Nevent{
  ...
  @doc """
  ## Examples
      iex> %Nostrlib.Encoding.Nevent{
      ...>   author: <<223, 23, 50, 119, 24, 47, 49, 85, 211, 123, 51, 2, 17, 186, 29, 228, 168, 21, 0, 192, 45, 25, 94, 150, 79, 145, 190, 119, 78, 201, 103, 8>>,
      ...>   id: <<253, 207, 78, 151, 30, 188, 218, 125, 222, 91, 107, 33, 48, 73, 44, 249, 159, 213, 140, 63, 142, 156, 197, 81, 73, 143, 6, 130, 170, 167, 68, 48>>,
      ...>   kind: 1,
      ...>   relays: ["wss://relay.damus.io"]
      ...> }
      ...> |> Nostrlib.Encoding.Nevent.encode()
