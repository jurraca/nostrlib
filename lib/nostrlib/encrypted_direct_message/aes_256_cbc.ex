defmodule Nostrlib.Crypto.AES256CBC do
  @moduledoc """
  ...
  ## Examples
      ...
      ...> |> Nostrlib.Crypto.AES256CBC.encrypt(local_private_key, remote_public_key)
  """
  ...
  ## Examples
      ...
      ...> |> Nostrlib.Crypto.AES256CBC.decrypt(local_private_key, remote_public_key)
      {:ok, "test"}
  """
