defmodule Nostrlib.Models.EncryptedDirectMessage do
  @moduledoc """
  ...
  ## Examples
      iex> {:ok, event} = %Nostrlib.Models.EncryptedDirectMessage{
      ...
      ...> }
      ...> |> Nostrlib.Models.EncryptedDirectMessage.to_event(<<0x4E22DA43418DD934373CBB38A5AB13059191A2B3A51C5E0B67EB1334656943B8::256>>)
      ...> %Nostrlib.Event{event | content: nil}
      %Nostrlib.Event{
